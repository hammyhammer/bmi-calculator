    ...
    <div>
      ...
      <div className={skininfocss.body}>
        <p>Skin checks help detect skin cancer in the earlier stages.
          <br />
          <br />A skin check is not used to diagnosis skin cancer<a className={skininfocss.reference} href="https://medlineplus.gov/lab-tests/skin-cancer-screening/#:~:text=The%20screening%20checks%20the%20skin,cell%20and%20squamous%20cell%20cancers.">[1].</a>.
          <br />
