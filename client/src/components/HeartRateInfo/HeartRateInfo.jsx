    ...
    <div className={heartinfocss.whole}>
      ...
      <div className={heartinfocss.body}>
        <p>Our resting heart rate can provide some information regarding our fitness level, heart health and emotional health
          <a className={heartinfocss.reference} href="https://www.sutterhealth.org/health/heart/get-to-know-your-heart-rate-it-might-save-your-life#:~:text=Track%20Your%20Heart%20Rate,dehydration%2C%20inactivity%20and%20persistent%20stress.">[1]</a>.
          <br />
          <br />
          Your heart rate by itself is not enough to determine if there is a health issue we ought to be aware of.
          Many factors such as having a fever, being under stress, or dehydration can affect your resting heart rate<a className={heartinfocss.reference} href="https://www.cdc.gov/healthyweight/assessing/bmi/adult_bmi/index.html">[2]</a>.
        </p>
      </div>
